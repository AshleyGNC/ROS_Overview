...
"""autogenerated by genpy from rosjava_test_msgs/TestArrays.msg. Do not edit."""
import codecs
import sys
...
class TestArrays(genpy.Message):
  ...
  _type = "rosjava_test_msgs/TestArrays"
...
"""
  ...
  _slot_types = ['string','string','int32[]','float32[]','time[]','rosjava_test_msgs/TestString[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.test_string_array = []
      for i in range(0, length):
        val1 = rosjava_test_msgs.msg.TestString()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
