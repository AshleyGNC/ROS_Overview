...
class Composite(genpy.Message):
  ...
  _type = "rosjava_test_msgs/Composite"
...
"""
  __slots__ = ['a','b']
  _slot_types = ['rosjava_test_msgs/CompositeA','rosjava_test_msgs/CompositeB']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.a is None:
        self.a = rosjava_test_msgs.msg.CompositeA()
      if self.b is None:
        self.b = rosjava_test_msgs.msg.CompositeB()
    else:
      self.a = rosjava_test_msgs.msg.CompositeA()
      self.b = rosjava_test_msgs.msg.CompositeB()
