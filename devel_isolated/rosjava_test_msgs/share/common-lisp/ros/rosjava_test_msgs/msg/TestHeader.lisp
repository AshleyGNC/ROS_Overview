...
(cl:in-package rosjava_test_msgs-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <TestHeader>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TestHeader)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosjava_test_msgs-msg:<TestHeader> is deprecated: use rosjava_test_msgs-msg:TestHeader instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <TestHeader>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosjava_test_msgs-msg:header-val is deprecated.  Use rosjava_test_msgs-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'caller_id-val :lambda-list '(m))
(cl:defmethod caller_id-val ((m <TestHeader>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosjava_test_msgs-msg:caller_id-val is deprecated.  Use rosjava_test_msgs-msg:caller_id instead.")
  (caller_id m))

(cl:ensure-generic-function 'orig_caller_id-val :lambda-list '(m))
(cl:defmethod orig_caller_id-val ((m <TestHeader>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosjava_test_msgs-msg:orig_caller_id-val is deprecated.  Use rosjava_test_msgs-msg:orig_caller_id instead.")
  (orig_caller_id m))

(cl:ensure-generic-function 'auto_header-val :lambda-list '(m))
(cl:defmethod auto_header-val ((m <TestHeader>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosjava_test_msgs-msg:auto_header-val is deprecated.  Use rosjava_test_msgs-msg:auto_header instead.")
  (auto_header m))
